...
import johnengine.basic.renderer.rew.components.VBOIndices;
import johnengine.basic.renderer.rew.components.VBOTextureCoordinates;
import johnengine.basic.renderer.rew.components.VBOVertices;
...
public class Mesh extends ARendererAsset<VertexArrayObject> {
    ...
    public static void populateMeshWithAIMesh(Mesh dest, AIMesh src) {
        ...
        for( int i = 0; i < s; i++ )
        {
            ...
            faces.add(new Face(face.mIndices().array()));
